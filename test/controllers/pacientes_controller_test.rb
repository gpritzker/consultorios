...
class PacientesControllerTest < ActionController::TestCase
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post :create, paciente: { cobertura: @paciente.cobertura, dni: @paciente.dni, email: @paciente.email, nombre: @paciente.nombre, telefono: @paciente.telefono }
    end
  ...
  test "should update paciente" do
    patch :update, id: @paciente, paciente: { cobertura: @paciente.cobertura, dni: @paciente.dni, email: @paciente.email, nombre: @paciente.nombre, telefono: @paciente.telefono }
    assert_redirected_to paciente_path(assigns(:paciente))
  end
